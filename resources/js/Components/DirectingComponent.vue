<template>
  <div class="flex items-center justify-center pb-16 bg-gray-950">
    <div class="w-11/12 border-2 border-white rounded-xl p-6">
      <div className="title">Réalisation :</div>
      <div v-for="media in directing">
        <Link :href="getRouteType(media.media_type, media.id)" className="movie">
          ...
          <div>
            ...
            <span className="job">{{ media.job }}</span>
